...
import CreateEventModal from './partials/create-event-modal';
import EditEventModal from './partials/edit-event-modal';
            ...
            <div className="p-6">
                <div className="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">Manage your events and ticket sales</p>
                    </div>
                    
                    {/* Using ShadCN Dialog with controlled state */}
